    ...
    <div className="min-h-[100dvh] bg-background">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-20 md:py-28">
        ...
        <section className="mt-20 grid gap-5 sm:mt-28 sm:grid-cols-3 sm:gap-6">
          <div className="group rounded-xl border border-border bg-card p-5 shadow-sm transition-shadow hover:shadow sm:p-6">
        ...
        <section className="mt-20 rounded-2xl border border-border bg-card/50 px-6 py-10 text-center sm:mt-28 sm:px-10 sm:py-12">
